...
// Files and folders to copy for SimpleShop APIer
  ...
  const filesToCopy = [
    ...
    'dotenv-test.js',
    'api-dotenv-test.js',
    'correct-dotenv-test.js',
    'working-dotenv-test.js',
    'exact-working-test.js',
    'simple-api-test.js',
    'api-structure-test.js',
    'admin-vars-test.js',
    'basic-vars-test.js',
    'exact-pattern-test.js',
    'simple-api.js',
    'database-test.js',
    'api-routes-test.js',
...
function buildProject() {
  ...
  console.log('📁 Source files will be uploaded and built on the server via Plesk');
}
...
function createDeploymentInfo() {
  const deploymentInfo = {
    ...
    criticalNotes: [
      ...
      'web.config routes to dist/server.js'
    ]
  };
...
3. Test basic setup: \`node dist/server.js\`
